...
2. [Visual Entity Navigator for Kyndryl Digital Workplace Services](./docs/Kyn-index.html) for interactively exploring entities, entity extensions/inheritance, attributes, and relationships
